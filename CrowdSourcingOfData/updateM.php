...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    if(empty($supplier_name_err) && empty($status_err) && empty($district_err)){
        ...
        $sql = "UPDATE medicine_supply SET Supplier_Name=?, District=?, Sub_item=?, Status=? WHERE Supplier_Contact=?";
    ...
    $sql = "SELECT * FROM medicine_supply WHERE Supplier_Contact = " . $_GET["id"];
...
<div class="w3-teal w3-xlarge w3-padding-16 w3-margin-top w3-center">
    <h2>Update Medicine Supplier Details Correctly</h2>
</div>
